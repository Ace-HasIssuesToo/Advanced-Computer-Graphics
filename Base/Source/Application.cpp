...
void Application::Init()
{
	...
	//Set the 2 Variables to Zero
	m_dElapsedTime = 0;
	m_dAccumulatedTime_Thread1 = 0.0;
	m_dAccumulatedTime_Thread2 = 0.0;
	m_dAccumulatedTime_Thread3 = 0.0;
}
bool Application::GetCamDirUpdate()
{
...
void Application::Run()
{
	...
	while (!glfwWindowShouldClose(m_window) && !IsKeyPressed(VK_ESCAPE))
	{
		...
		m_dAccumulatedTime_Thread3 += m_dElapsedTime;
		if (m_dAccumulatedTime_Thread1 > 1/60)
		{
			GetMouseUpdate();
			GetCamDirUpdate();
			GetKeyboardUpdate();
		...
		if (m_dAccumulatedTime_Thread2 > 0.03)
		{
			//updateAI();
			m_dAccumulatedTime_Thread2 = 0.0;
		}
