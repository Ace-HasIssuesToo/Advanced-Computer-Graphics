...
void SceneText::Init()
{
	...
	meshList[GEO_CUBE3] = MeshBuilder::GenerateCube("cube2", Color(0, 1, 0), 1);
	...
	meshList[GEO_TERRAIN]->textureArray[1] = LoadTGA("Image//ground.tga");
...
{
	modelStack.PushMatrix();
	modelStack.Translate(500, 1800, -500); //Fit that Skyplane
...
void SceneText::Render()
{
	...
	{
		modelStack.PushMatrix();
		modelStack.Translate(arrBullets[i].GetPosition().x, arrBullets[i].GetPosition().y, arrBullets[i].GetPosition().z);
